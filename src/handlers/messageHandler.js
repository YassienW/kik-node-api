module.exports = (client, callbacks, id, data) => {
    ...
    if(type === "groupchat"){
        ...
        let user = null//client.users.find((user) => {return user.jid === data.find("message").attrs.from})
        ...
        if(data.find("xiphias-mobileremote-call")){
            ...
            let user = {jid: data.find("message").attrs.from, username: null, displayName: null}
